...
var NoctuaBasicControllerBundle = ['$animate', '$timeout', '$location', '$anchorScroll', 'toastr', '$window', '$rootScope', NoctuaBasicController];

angular
  .module('noctuaBasicApp')
  .controller('NoctuaBasicController', NoctuaBasicControllerBundle);
